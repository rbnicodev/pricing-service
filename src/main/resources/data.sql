MERGE INTO brands (id, name) VALUES
(1, 'ZARA');

MERGE INTO price_lists (id, name) VALUES
(1, 'Price List A'),
(2, 'Price List B'),
(3, 'Price List C'),
(4, 'Price List D');

MERGE INTO products (id, name) VALUES
(35455, 'Black shoes');

MERGE INTO prices (id, brand_id, start_date, end_date, price_list, product_id, priority, price, curr) VALUES
